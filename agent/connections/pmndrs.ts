 ...
 * `pmndrs_docs_index` tool first to list the real paths for a library — it also
...
export default defineMcpClientConnection({
  ...
  description: [
    ...
    "given a library name and a page path. Get the paths from the",
    "pmndrs_docs_index tool first — a guessed path is an error, not a redirect.",
